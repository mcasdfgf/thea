...
To understand how T.H.E.A. achieves its goals, one must look at the three key principles of its architecture. A full description is available in **[ARCHITECTURE.en.md](ARCHITECTURE.en.md)**.

*   **Ontology-Before-Code:** The architecture was not chosen, but *derived* from its own ontological model, **"The Assembler of Being."** Every service and module is a direct consequence of philosophical axioms about the nature of cognition. The detailed model is described in **[THEORY.en.md](THEORY.en.md)**.
...
The complete vision and detailed roadmap are presented in **[VISION.en.md](VISION.en.md)**.
